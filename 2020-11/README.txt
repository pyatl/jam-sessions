...
(and complex) algorithms. Sorted collections are always just one sorted()
call away!
...
You will need to write your code in sorting.py. The list_to_sort variable will
hold a list of integers, and your code needs to sort it! Using any of the
...
One of the easiest sorting strategies to implement is the insertion sor.
