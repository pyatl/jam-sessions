...
Write your code in `puzzle_2.py`. The functions `part_1` and `part_2` will automatically be provided with the puzzle input from `puzzle_2.txt`, as a list of strings (one line per item).
